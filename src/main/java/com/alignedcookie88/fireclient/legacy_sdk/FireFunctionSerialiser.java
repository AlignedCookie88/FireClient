...
import com.alignedcookie88.fireclient.legacy_sdk.serialisation.DFTemplate;
import com.alignedcookie88.fireclient.legacy_sdk.serialisation.blocks.FunctionBlock;
import com.alignedcookie88.fireclient.legacy_sdk.serialisation.blocks.PlayerActionBlock;
import com.alignedcookie88.fireclient.legacy_sdk.serialisation.variables.FunctionParameterVariable;
import com.alignedcookie88.fireclient.legacy_sdk.serialisation.variables.ItemVariable;
import com.alignedcookie88.fireclient.legacy_sdk.serialisation.variables.StringVariable;
...
//        );
    ...
    private static String getArgumentString(FireFunction function) {
        StringBuilder string = new StringBuilder(".fireclient " + FireClient.legacyFunctionRegistry.getId(function).asString());
