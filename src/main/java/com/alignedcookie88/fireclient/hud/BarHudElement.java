...
public class BarHudElement extends PositionalHudElement {
    ...
    private static final Identifier[] BACKGROUND_TEXTURES = new Identifier[]{new Identifier("textures/gui/sprites/boss_bar/pink_background.png"), new Identifier("textures/gui/sprites/boss_bar/blue_background.png"), new Identifier("textures/gui/sprites/boss_bar/red_background.png"), new Identifier("textures/gui/sprites/boss_bar/green_background.png"), new Identifier("textures/gui/sprites/boss_bar/yellow_background.png"), new Identifier("textures/gui/sprites/boss_bar/purple_background.png"), new Identifier("textures/gui/sprites/boss_bar/white_background.png")};
    private static final Identifier[] PROGRESS_TEXTURES = new Identifier[]{new Identifier("textures/gui/sprites/boss_bar/pink_progress.png"), new Identifier("textures/gui/sprites/boss_bar/blue_progress.png"), new Identifier("textures/gui/sprites/boss_bar/red_progress.png"), new Identifier("textures/gui/sprites/boss_bar/green_progress.png"), new Identifier("textures/gui/sprites/boss_bar/yellow_progress.png"), new Identifier("textures/gui/sprites/boss_bar/purple_progress.png"), new Identifier("textures/gui/sprites/boss_bar/white_progress.png")};
